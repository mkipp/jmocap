...
public class DiskJmocap implements DiskInterface{
    ...
    /**
    * get the figure
    * get the position of the bone to set the default disk on
    * @param jmocap
    */
    public DiskJmocap(JMocap jmocap){
    ...
    /**
    * get all positions of the skeleton's bone
    * and write it into a list
    * later calculate the speed of every frame for the disk's radius
    */
    ...
    /**
    * creates a primitive disk
    * add disk to JMocap's root
    * add the listener
    */
    public void setDisk() {
    ...
    /**
    * returns the appropriate transformation of the disk
    * this includes the size and the position as well as the color
    */
    ...
    /**
    * if the skeleton did not move the disk color will be set to grey
    * else it is set to cyan
    * @param relaxing
    ...
    */
    ...
    /**
    * set the speed of every frame that represents the radius of the disk
    * and get the average angle
    */
