...
public class DistancePlateJMocap implements DistancePlateInterface{
    ...
    */
    ...
    /**
    * set distancePlate
    * add distancePlate, text to JMocap's root
    * add a listener
    */
    ...
    */
    ...
    /**
    * returns the possibly altered distanceObject
    * therefore it checks the color, the size and angle
    */
    ...
    */
    ...
    /**
    * get all positions of the figures bone
